...
TAB2       = "Kirjaa kulut & aseta palkkatavoite"
...
Jos sopimus on päättynyt, näkyy se listassa punaisella – poista tai uusi sopimus.  

Laskuri laskee sopimusten arvoon mukaan vain voimassaolevat sopimukset.
</span>
"""
)
...
KULUT_INTRO       = (
    """
Syötä yrityksen tilikauden kulut (ilman ALV:a).  

Voit lisätä puuttuvan kulun, jos jotain kulua ei löydy listasta.
"""
)

ENNUSTE_INTRO     = (
    """
Suunnittele tavoitepalkkasi edellyttämä lisämyynti kuluvalle tilikaudelle. Kirjaa myyntiennusteet asiakkaiden ja tuotteiden mukaan. 
